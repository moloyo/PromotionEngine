...
namespace PromotionEngine.Application.Features.Promotions.GetAll.V2
{
    public class HandlerTests
    {
        ...
        public async Task HandleAsync_ReturnsPromotion_IfFound()
        {
            ...
            var promitions = new List<Promotion>() { promotion, promotion, promotion };
            var maxPromotions = 2;
            var request = new Request("DE", "DE", maxPromotions);
            ...
            Assert.Equal(response.Promotions.Count(), maxPromotions);
        }
